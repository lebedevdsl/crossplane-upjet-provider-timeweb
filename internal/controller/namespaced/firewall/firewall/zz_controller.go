...
import (
	...
	v1alpha1 "github.com/lebedevdsl/crossplane-upjet-provider-timeweb/apis/namespaced/firewall/v1alpha1"
	features "github.com/lebedevdsl/crossplane-upjet-provider-timeweb/internal/features"
)

// SetupGated adds a controller that reconciles Firewall managed resources.
func SetupGated(mgr ctrl.Manager, o tjcontroller.Options) error {
	o.Options.Gate.Register(func() {
		if err := Setup(mgr, o); err != nil {
			mgr.GetLogger().Error(err, "unable to setup reconciler", "gvk", v1alpha1.Firewall_GroupVersionKind.String())
		}
	}, v1alpha1.Firewall_GroupVersionKind)
	return nil
}
...
func Setup(mgr ctrl.Manager, o tjcontroller.Options) error {
	...
	ac := tjcontroller.NewAPICallbacks(mgr, xpresource.ManagedKind(v1alpha1.Firewall_GroupVersionKind), tjcontroller.WithEventHandler(eventHandler))
	opts := []managed.ReconcilerOption{
		managed.WithExternalConnecter(tjcontroller.NewConnector(mgr.GetClient(), o.WorkspaceStore, o.SetupFn, o.Provider.Resources["twc_firewall"], tjcontroller.WithLogger(o.Logger), tjcontroller.WithConnectorEventHandler(eventHandler),
