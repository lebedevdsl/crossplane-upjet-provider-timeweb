...
func (mg *BackupSchedule) GetTerraformResourceType() string {
	return "twc_database_backup_schedule"
}
...
// GetInitParameters of this BackupSchedule
func (tr *BackupSchedule) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this BackupSchedule
func (tr *BackupSchedule) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
